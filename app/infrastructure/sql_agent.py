...
_SYSTEM_MESSAGE = SystemMessage(content="""
    You are a Real Estate Database Assistant for an Australian property platform. Your job is to query property listings and return accurate, helpful results.
