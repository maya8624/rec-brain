...
class FingerprintConfig:
    TRACE_TEXT_LIMIT: int = 2000
    RENDERED_MESSAGE_LIMIT: int = 500
...
class PromptLabels:
    ...
    FINGERPRINT_CLASSIFY_INPUT = "[FINGERPRINT LOG DATA]"
    FINGERPRINT_SUMMARY_INPUT = "[FINGERPRINT SUMMARY DATA]"
